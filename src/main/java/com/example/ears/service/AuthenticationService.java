...
public class AuthenticationService {
    ...
    public User authentication(LoginUserDto input) {
        ...
        if (!user.isEnabled()) {
            throw new RuntimeException("User is not verified. Please verify user");
        }
    ...
    public void sendVerificationEmail(User user) {
        ...
        String htmlMessage = "<html>"
                ...
                +"<p style=\"font-size: 16px;\">To verify your email address, please enter the verification code:</p>"
        ...
        try {
            emailService.sendVerification(user.getEmail(), subject, htmlMessage);
    ...
    private String generateVerificationCode() {
        ...
        int code = random.nextInt(100000) + 90000;
